...
def main():
    ...
    print(digram_ranking(cryptogram, 10))
    print(trigram_ranking(cryptogram, 50))
    
    # you can write here your code for the lab and test it with "python3 AISC_01.py
#,'WS':'th','W':'t','S':'h','C':'e', 'F':'o','E':'b','C':'t', 'I':'i', 'W':'a'
    replacment = {'W':'t','S':'h','C':'e','A':'n','V':'g', 'E':'a', 'P':'d','G':'i','N':'b', 'I':'o','U':'m','R':'k','F':'s'
    ,'H':'r','B':'y','K':'w','J':'u','Z':'c','D':'l','T':'v','M':'f'}
    for oldC, newC in replacment.items():
        cryptogram = cryptogram.replace(oldC, newC)
